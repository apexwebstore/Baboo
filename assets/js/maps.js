(function ($) {
    ...
    if ($(".cordinate").length > 0) {
        ...
        if (building_log != "" && building_lat != "") {
            ...
            mapboxgl.accessToken = 'pk.eyJ1IjoiaW00dWRlZXBhayIsImEiOiJjazBka3l6MmcwMDB1M2RucDhpd2VhdDM2In0.yyojbV3-v2g8pp2zpBzOwQ';
            ...
            if (!mapboxgl.supported()) {
                ...
                var pulsingDot = {
                    ...
                    render: function () {
                        ...
                        context.fillStyle = 'rgba(255, 132, 0,' + (1 - t) + ')';
